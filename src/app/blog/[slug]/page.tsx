      ...
      <div className="grid gap-3">
        {items.map((item, index) => (
          <Link
            key={index}
            href={item.url}
            className="flex items-start gap-3 bg-white rounded-xl p-4 border border-slate-200 hover:border-blue-300 hover:shadow-sm transition-all group"
          >
            ...
            <ExternalLink className="w-4 h-4 text-slate-400 group-hover:text-blue-500 flex-shrink-0 mt-1" />
          </Link>
        ))}
      </div>
    </aside>
              ...
              <div className="max-w-3xl mx-auto">
                ...
                <div
                  className="prose prose-lg prose-slate max-w-none mb-12
                    ...
                    [&_.internal-link]:text-blue-600 [&_.internal-link]:font-medium"
