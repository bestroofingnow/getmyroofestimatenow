        ...
        <div className="grid lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            {apiComplete && roofData && (
              <div className="lg:hidden bg-orange-50 rounded-xl p-4 border border-orange-100">
                <div className="grid grid-cols-2 gap-4 text-center">
                  <div>
                    <p className="text-sm text-orange-600">Roof Size</p>
                    <p className="text-lg font-bold text-orange-900">{roofData.roofSqFt.toLocaleString()} sq ft</p>
                  </div>
                  <div>
                    <p className="text-sm text-orange-600">Est. Range</p>
