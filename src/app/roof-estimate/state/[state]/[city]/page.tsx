          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-orange-200 font-medium">{location.city}, {location.state}</span>
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="bg-orange-600 rounded-2xl p-6 text-center text-white transform scale-105 shadow-xl">
                  <div className="text-sm font-medium text-orange-200 mb-2">Most Popular</div>
                  <div className="text-3xl font-bold mb-2">
                    {formatCurrency(location.avgRoofCost.mid)}
                  </div>
                  <div className="text-sm text-orange-100">Architectural shingles, quality materials</div>
                </div>
                <div className="bg-slate-50 rounded-2xl p-6 text-center border border-slate-200">
                ...
                <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                  {cityNeighborhoods.map((neighborhood) => (
                    <Link
                      ...
                      className="flex items-center gap-2 p-4 bg-slate-50 rounded-xl hover:bg-orange-50 hover:text-orange-600 transition-colors group border border-slate-200 hover:border-orange-300"
                    >
                      <MapPin className="w-4 h-4 text-slate-400 group-hover:text-orange-500 flex-shrink-0" />
                      <span className="font-medium">{neighborhood.name}</span>
                      <ArrowRight className="w-4 h-4 ml-auto text-slate-300 group-hover:text-orange-500" />
                    </Link>
                  ))}
                </div>
              </div>
