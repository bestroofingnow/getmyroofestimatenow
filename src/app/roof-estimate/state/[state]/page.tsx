          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <div className="flex items-center justify-center gap-2 mb-4">
                ...
                <span className="text-blue-200 font-medium">{stateInfo.name} ({stateInfo.abbr})</span>
              </div>
        ...
        <section className="py-8 bg-white border-b border-slate-200">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
              ...
              <div>
                <div className="text-3xl font-bold text-blue-600">{formatCurrency(stateInfo.averageCostRange.low)}</div>
                <div className="text-sm text-slate-600">Starting Cost</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-blue-600">{formatCurrency(stateInfo.averageCostRange.high)}</div>
