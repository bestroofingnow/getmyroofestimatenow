    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <label className="flex items-start gap-3 cursor-pointer group">
        <input
          ...
          required
          className="mt-1 w-5 h-5 rounded border-slate-300 text-orange-600
                     focus:ring-orange-500 focus:ring-2 cursor-pointer"
        />
      ...
      <button
        ...
        className="w-full py-4 bg-gradient-to-r from-orange-600 to-blue-600 text-white font-semibold
                   rounded-lg hover:from-orange-500 hover:to-blue-500
